...
interfaces, a selected four-channel collision permutation and its admitted
local subtype, independent finite scattering layers, directed sampled routes,
mirror/delay/crossover certificates, and a four-tick Figure 14 reconstruction.
